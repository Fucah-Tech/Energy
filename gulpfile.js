...
var paths = {
	...
	html: {
		...
		dest: './assets',
		watch: ['./source/template/pages/*.pug', './source/template/blocks/**/*.pug', './source/template/elements/**/*.pug', './source/template/layouts/*.pug', './source/template/mixins/*.pug']
	},
	...
	php: {
		src: './source/template/mail/*.php',
		dest: './assets/mail',
		watch: './source/template/mail/*.php'
	},
	...
	mail: {
		src: './source/send_mail/**/*',
		dest: './assets/send_mail',
		watch: './source/send_mail'
	}
...
gulp.task('mail', function () {
	return gulp.src(paths.mail.src)
		.pipe(plumber())
		.pipe(gulp.dest(paths.mail.dest))
		.pipe(browserSync.reload({
			stream: true
		}))
})
...
gulp.task('server', function () {
	...
	gulp.watch(paths.mail.watch, gulp.parallel('mail'))
